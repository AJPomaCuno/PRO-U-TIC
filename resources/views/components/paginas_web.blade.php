<section class="shop-section fix section-padding" id="paginas">
    <div class="container">
        ...
        <div class="swiper shop-slider">
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide">
                    <div class="shop-items">
                        <div class="shop-image">
                            <img src="{{ asset('assets/img/shop/siacop.jpg')}}" alt="shope-img">
                        </div>
                        <div class="shop-content">
                            <div class="price">
                                <h4>SIACOP-BOLETA COMISION</h4>
                            </div>
                            <h4 class="title">
